...
def fd():
    print('fd', request.headers.get('X-Real-IP'))
...
def edu():
    print('edu', request.headers.get('X-Real-IP'))
    return render_template('edu.html')


@app.route('/contacts', methods=['GET'])
def contacts():
    print('contacts', request.headers.get('X-Real-IP'))
    return render_template('contacts.html')


@app.route('/books', methods=['GET'])
def books():
    print('books', request.headers.get('X-Real-IP'))
    return render_template('books.html')


@app.route('/videos', methods=['GET'])
def videos():
    print('videos', request.headers.get('X-Real-IP'))
    return render_template('videos.html')


@app.route('/astro', methods=['GET'])
def astro():
    print('astro', request.headers.get('X-Real-IP'))
    return render_template('astro.html')


@app.route('/others', methods=['GET'])
def others():
    print('others', request.headers.get('X-Real-IP'))
    return render_template('others.html')


@app.route('/consultations', methods=['GET'])
def consultations():
    print('consultations', request.headers.get('X-Real-IP'))
    return render_template('consultations.html')


@app.route('/news', methods=['GET'])
def news():
    print('news', request.headers.get('X-Real-IP'))
    return render_template('news.html')


@app.route('/courses/fd', methods=['GET'])
def course_fd():
    print('courses/fd', request.headers.get('X-Real-IP'))
    return render_template('courses/fd.html')


@app.route('/courses/astro', methods=['GET'])
def course_astro():
    print('courses/astro', request.headers.get('X-Real-IP'))
    return render_template('courses/astro.html')


@app.route('/courses/karma', methods=['GET'])
def course_karma():
    print('courses/karma', request.headers.get('X-Real-IP'))
    return render_template('courses/karma.html')


@app.route('/courses/palmistry', methods=['GET'])
def course_palmistry():
    print('courses/palmistry', request.headers.get('X-Real-IP'))
    return render_template('courses/palmistry.html')


@app.route('/download-card', methods=['GET'])
def download_card():
    print('download-card', request.headers.get('X-Real-IP'))
...
def create_card():
    print('card', request.headers.get('X-Real-IP'))
    fio, birthday, city, age_units = get_card_params()
...
def create_transit():
    print('transit', request.headers.get('X-Real-IP'))
